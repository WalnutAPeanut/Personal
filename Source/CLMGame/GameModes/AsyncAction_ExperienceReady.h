 ...
 */
UCLASS()
class CLMGAME_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	void Step3_HandleExperienceLoaded(const UCLMExperienceDefinition* CurrentExperience);
