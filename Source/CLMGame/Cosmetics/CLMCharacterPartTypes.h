...
#include "CLMCharacterPartTypes.generated.h"
...
struct FCLMCharacterPartHandle
{
	GENERATED_BODY()
...
struct FCLMCharacterPart
{
	...
	static bool AreEquivalentParts(const FCLMCharacterPart& A, const FCLMCharacterPart& B)
	{
