...
//
///**
// * UCLMGameplayFeaturePolicy는 GameFeature Plugin이 Memory에 로딩되거나 Active(활성화)를 관리하는 StateMachine을 모니터링 가능하다
// */
//UCLASS()
...
//
//	/** Observer로서 등록한 객체를 관리 (아래 CLMGameFeature_AddGameplayCuePaths가 하나의 예시) */
//	UPROPERTY(Transient)
...
// * - 이를 위해 추가적 구현이 필요한데 이는 UCLMGameplayFeaturePolicy를 참고하자.
// *
