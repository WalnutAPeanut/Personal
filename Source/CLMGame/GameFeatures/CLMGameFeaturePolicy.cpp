//#include "CLMGameFeaturePolicy.h"
//#include "GameFeatureAction.h"
//#include "GameFeatureAction_AddGameplayCuePath.h"
//#include "GameFeatureData.h"
//#include "GameplayCueSet.h"
//#include "CLMGame/AbilitySystem/CLMGameplayCueManager.h"
//
//UCLMGameplayFeaturePolicy::UCLMGameplayFeaturePolicy(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
//{}
//
//void UCLMGameplayFeaturePolicy::InitGameFeatureManager()
//{
//	// GameFeature_AddGameplayCuePaths를 등록
//	Observers.Add(NewObject<UCLMGameFeature_AddGameplayCuePaths>());
//
...
//}
//
//void UCLMGameplayFeaturePolicy::ShutdownGameFeatureManager()
//{
...
//}
//
//void UCLMGameFeature_AddGameplayCuePaths::OnGameFeatureRegistering(const UGameFeatureData* GameFeatureData, const FString& PluginName, const FString& PluginURL)
//{
...
//			if (UCLMGameplayCueManager* GCM = UCLMGameplayCueManager::Get())
//			{
//				// RuntimeCueSet을 가져옴
...
//}
//
//void UCLMGameFeature_AddGameplayCuePaths::OnGameFeatureUnregistering(const UGameFeatureData* GameFeatureData, const FString& PluginName, const FString& PluginURL)
//{
//	const FString PluginRootPath = TEXT("/") + PluginName;
//	for (const UGameFeatureAction* Action : GameFeatureData->GetActions())
//	{
