...
//
//USTRUCT()
//struct FCLMHUDElementEntry
//{
//	GENERATED_BODY()
//
//	/** CLMHUDLayout 위에 올릴 대상이 되는 Widget Class */
//	UPROPERTY(EditAnywhere, Category = UI, meta = (AssetBundles = "Client"))
//	TSoftClassPtr<UUserWidget> WidgetClass;
//
//	/** SlotID는 CLMHUDLayoutRequest에 올린 LayoutClass에 정의된 Slot(GameplayTag)를 의미 */
//	UPROPERTY(EditAnywhere, Category = UI)
//	FGameplayTag SlotID;
//};
//
//UCLASS()
//class CLMGAME_API UGameFeatureAction_AddWidgets : public UGameFeatureAction_WorldActionBase
//{
//	GENERATED_BODY()
//public:
...
//	 */
//	UPROPERTY(EditAnywhere, Category=UI)
//	TArray<FCLMHUDLayoutRequest> Layout;
//
//	UPROPERTY(EditAnywhere, Category=UI)
//	TArray<FCLMHUDElementEntry> Widgets;
//};
